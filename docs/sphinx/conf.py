...
htmlhelp_basename = 'KorowaiFrameworkdoc'
...
latex_documents = [
    (master_doc, 'KorowaiFramework.tex', 'Korowai Framework Documentation',
...
man_pages = [
    (master_doc, 'korowaiframework', 'Korowai Framework Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'KorowaiFramework', 'Korowai Framework Documentation',
     author, 'KorowaiFramework', 'One line description of project.',
     'Miscellaneous'),
]
